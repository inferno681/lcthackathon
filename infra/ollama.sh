if [ ! -f ./data/llava-llama-3-8b-v1_1-mmproj-f16.gguf ]; then
    sudo wget -P ./data https://huggingface.co/xtuner/llava-llama-3-8b-v1_1-gguf/resolve/main/llava-llama-3-8b-v1_1-mmproj-f16.gguf
fi

if [ ! -f ./data/llava-llama-3-8b-v1_1-int4.gguf ]; then
    sudo wget -P ./data https://huggingface.co/xtuner/llava-llama-3-8b-v1_1-gguf/resolve/main/llava-llama-3-8b-v1_1-int4.gguf
fi
